      ...
      const onChangeUploadImageToFirebase = () => {
        ...
        uploadBytes(storageRef, filetPath).then((snapshot) => {
          ...
          getDownloadURL(snapshot.ref).then((downloadURL) => {
            ...
            api.post('/editBlog',{title,description:fullDescription,image:downloadURL,status,blogId})
            .then((res)=>{
...
onChangeUploadImageToFirebase()  
      ...
      if(descriptionStatus&&titleStatus&&image){
              
        api.post('/editBlog',{title,description:fullDescription,image,status,blogId})
        .then((res)=>{
          setFullDescription()
          setTitle('Title  !')
          setImage(false)
      ...
      api.post('/editBlog',{title,description:fullDescription,status,blogId})
      .then((res)=>{
        setFullDescription()
        setTitle('Title  !')
        setImage(false)
